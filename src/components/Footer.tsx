      ...
      <div className="wrapper relative z-10">
        <div className="flex flex-col lg:flex-row justify-between gap-16 lg:gap-8">
          ...
          <div className="lg:w-1/3 flex flex-col justify-between">
            <div>
              <Link
                to="/"
                className="text-4xl md:text-5xl font-maus font-bold tracking-tighter uppercase mb-6 inline-block"
              >
                Drafty
              </Link>
              <p className="text-gray-400 text-lg leading-relaxed max-w-sm font-coolvetica tracking-wide">
                Empowering Architects and Engineers with precision drafting and
                BIM solutions. We build the foundation of your vision.
              </p>
            </div>
          ...
          <div className="lg:w-2/3 flex flex-col md:flex-row gap-10 md:gap-20 justify-end">
            ...
            {/* Company */}
            <div>
              <h4 className="font-maus text-xl text-white mb-6 uppercase tracking-wider">
                Company
              </h4>
            ...
            <div>
              ...
              <ul className="flex flex-col gap-4 text-lg text-gray-300 font-coolvetica tracking-wide">
                ...
                <li className="flex gap-4 mt-2">
                  ...
                  <a
                    href="#"
                    className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-brandorange hover:text-black transition-all"
                  >
                    <FaLinkedinIn />
                  </a>
                  <a
                    href="#"
                    className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-brandpink hover:text-white transition-all"
                  >
                    <FaInstagram />
                  </a>
                </li>
        ...
        <div className="mt-20 pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4 text-gray-500 text-md font-coolvetica tracking-wide">
          ...
          <p className="text-gray-400 text-sm">
            Image credits: Juan Lugo, Rina Lu, Mekhak Elizabaryan
          </p>
