...
const Preloader = () => {
    ...
    return (
        <div
            ref={containerRef}
            className="fixed inset-0 z-[999] flex items-center justify-center overflow-hidden bg-white border-b-4 border-brandturquoise h-screen w-screen max-w-[100vw] overflow-x-hidden" // White Background
        >
            {/* Content Layer */}
