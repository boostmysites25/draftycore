...
import { FaStar, FaArrowDown, FaGlobe, FaSmile, FaCog, FaHeart, FaClock, FaShieldAlt, FaRulerCombined, FaUsers } from 'react-icons/fa';
...
const items = [
  {
    ...
    icon: <FaStar />,
    description: "Our drafting teams maintain the highest standards of accuracy, ensuring every line and dimension meets strict Australian engineering protocols.",
  ...
  },
  {
    ...
    icon: <FaArrowDown />,
    description: "We understand that time is money. Our workflow is optimized to deliver detailed shop drawings significantly faster than traditional methods.",
  ...
  },
  {
    ...
    icon: <FaGlobe />,
    description: "Scale your drafting capacity up or down instantly. We provide the resources you need, exactly when you need them.",
  ...
  },
  {
    ...
    icon: <FaSmile />,
    description: "Reduce overheads without compromising quality. Our remote drafting model offers significant cost savings for design firms.",
  ...
  },
  {
    ...
    title: "LATEST TECH",
    icon: <FaCog />,
    description: "We utilize the latest BIM and CAD software to ensure compatibility and integration with your existing project workflows.",
  ...
  },
  {
    ...
    icon: <FaHeart />,
    description: "You get a dedicated project manager who ensures clear communication and timely delivery throughout the project lifecycle.",
  ...
  },
  {
    ...
    icon: <FaClock />,
    description: "Our global team structure allows for round-the-clock progress on your projects, minimizing downtime.",
  ...
  },
  {
    ...
    title: "SECURE DATA",
    icon: <FaShieldAlt />,
    description: "We employ enterprise-grade security protocols to protect your intellectual property and project data at all times.",
  ...
  },
  {
    ...
    description: "We adapt our drafting standards and processes to match your firm's specific requirements and templates.",
  ...
  },
  {
    ...
    icon: <FaUsers />,
    description: "Our drafters are not just CAD operators; they are engineering professionals with deep domain knowledge.",
              ...
              {items.map((item, index) => (
                ...
                >
                    ...
                    className={`
                        ...
                        ${index === activeIndex 
                        ? 'bg-white shadow-xl scale-110 translate-x-4 z-10' 
                        : 'bg-transparent border border-white/30 text-white/60 scale-95 hover:bg-white/10'}
                    `}
                    >
                    <span className={`text-2xl ${index === activeIndex ? 'text-[#E087FF]' : 'text-current'}`}>
                        {item.icon}
                    </span>
                    <span className={`font-coolvetica font-bold tracking-wide uppercase text-xl ${index === activeIndex ? 'text-black' : 'text-current'}`}>
                        {item.title}
                    </span>
                    </button>
                </div>
            ...
            >
                {items.map((item, index) => (
                    ...
                    >
                        ...
                        `}>
                            {/* Card Image */}
                            <div className="relative flex-1 rounded-[2.5rem] overflow-hidden mb-6 bg-gray-100">
                                <img 
                                    src={item.image} 
                                    alt={item.title}
                                ...
                                <div className="absolute top-6 left-6 bg-white/90 backdrop-blur-md px-6 py-3 rounded-full text-sm font-bold tracking-widest uppercase flex items-center gap-3 shadow-lg">
                                    <span className="text-[#E087FF] text-lg">{item.icon}</span> {item.title}
                                </div>
                            </div>
