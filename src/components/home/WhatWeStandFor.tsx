...
const WhatWeStandFor = () => {
  return (
    <div className="relative border-t-4 border-brandlimegreen h-[110vh] lg:h-[88vh] lg:max-h-screen lg:overflow-hidden lg:flex lg:flex-col">
      <ConnectiveTech />
      <div className="wrapper absolute inset-0 top-24 z-10 lg:flex-none pt-24 lg:pt-12">
      ...
      <div className="relative z-[-1] xl:z-10 lg:flex-1 lg:overflow-hidden h-full">
        <FallingText
          text={[
            "Precision",
            "Speed",
