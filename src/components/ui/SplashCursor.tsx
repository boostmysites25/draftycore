...
export default function SplashCursor({
    ...
    `
        ...
        function generateColor(): ColorRGB {
            // brandorange: "#FF7A00" -> 1.0, 0.48, 0.0
            // brandyellow: "#FFC300" -> 1.0, 0.76, 0.0
            // brandpink: "#FF2D95" -> 1.0, 0.18, 0.58
            // brandlimegreen: "#B8F135" -> 0.72, 0.94, 0.21
            // brandturquoise: "#2ED9C3" -> 0.18, 0.85, 0.76
            const colors = [
                { r: 1.0, g: 0.48, b: 0.0 },
                { r: 1.0, g: 0.76, b: 0.0 },
                { r: 1.0, g: 0.18, b: 0.58 },
                { r: 0.72, g: 0.94, b: 0.21 },
                { r: 0.18, g: 0.85, b: 0.76 }
            ];

            const c = colors[Math.floor(Math.random() * colors.length)];

            // Original mix was c.r * 0.15 etc. Preserving some intensity adjustment if needed, 
            // but usually these shaders expect 0-1 float values. 
            // The original code dimmed them significantly:
            // c.r *= 0.15; c.g *= 0.15; c.b *= 0.15;

            // Let's try returning them somewhat raw but slightly adjusted for the 'fluid' look if it's too bright:
            return {
                r: c.r * 0.2, // Adjusted intensity for fluid effect 
                g: c.g * 0.2,
                b: c.b * 0.2
            };
        }
